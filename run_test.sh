...
$PWD/gophermarttest -test.v -accrual-binary-path $PWD/cmd/accrual/accrual_linux_amd64 -accrual-database-uri "postgres://postgres@127.0.0.1:5432/market?&sslmode=disable" \
